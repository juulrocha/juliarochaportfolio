...
export const site = {
  ...
  "a minha forma de pensar comunicação.",
  about: {
    eyebrow: "Sobre",
    title: "Júlia Rocha",
...
export const categories: CategorySummary[] = [
  ...
  { slug: "audiovisual", number: "02", name: "Audiovisual", cover: "https://i.postimg.cc/YqNk7hV2/Whats-App-Image-2026-07-18-at-02-20-40.jpg" },
